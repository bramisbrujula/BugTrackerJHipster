package com.acme.bugtrack.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.acme.bugtrack.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.acme.bugtrack.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.acme.bugtrack.domain.User.class.getName());
            createCache(cm, com.acme.bugtrack.domain.Authority.class.getName());

...
import com.acme.bugtrack.repository.TicketRepository;
...
/**
 * REST controller for managing {@link com.acme.bugtrack.domain.Ticket}.
 */
@RestController
...
public class TicketResource {
    ...
    public ResponseEntity<Ticket> createTicket(@Valid @RequestBody Ticket ticket) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/tickets/" + ticket.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, ticket.getId().toString()))
            .body(ticket);
    }

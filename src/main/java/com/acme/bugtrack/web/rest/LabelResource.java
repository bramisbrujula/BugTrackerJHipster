...
/**
 * REST controller for managing {@link com.acme.bugtrack.domain.Label}.
 */
@RestController
...
public class LabelResource {
    ...
    public ResponseEntity<Label> createLabel(@Valid @RequestBody Label label) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/labels/" + label.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, label.getId().toString()))
            .body(label);
    }

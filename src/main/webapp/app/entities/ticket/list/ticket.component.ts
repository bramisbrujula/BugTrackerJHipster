...
import { EntityArrayResponseType, TicketService } from '../service/ticket.service';
...
export class TicketComponent implements OnInit {
  ...
  trackId = (item: ITicket): number => this.ticketService.getTicketIdentifier(item);
